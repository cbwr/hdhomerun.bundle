...
class Channel:
    ...
    def equals(self, other):
        Log( "Channel.py equals ..." )
        return self.getId() == other.getId()
    
    ########################################
    def isVerified(self):
        Log( "Channel.py isVerified ..." )
        """
    ...
    def getIconImageName(self):
        Log( "Channel.py getIconImageName ..." )
...
def getStreamUrlTemplates( deviceId, tunerId ):
    Log( "Channel.py getStreamUrlTemplates ..." )
    templateUrls = []
